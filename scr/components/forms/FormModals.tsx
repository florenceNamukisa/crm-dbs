...
export function FormModals() {
  ...
  return (
    <>
      ...
      <Dialog open={openForm === "contact"} onOpenChange={(open) => !open && setOpenForm(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Create New Contact</DialogTitle>
            <DialogDescription>Contact details and optional metadata.</DialogDescription>
          </DialogHeader>
          <CreateContactForm onClose={() => setOpenForm(null)} />
        </DialogContent>
      </Dialog>

      <Dialog open={openForm === "task"} onOpenChange={(open) => !open && setOpenForm(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Create New Task</DialogTitle>
            <DialogDescription>Tasks related to clients or contacts.</DialogDescription>
          </DialogHeader>
          <CreateTaskForm onClose={() => setOpenForm(null)} />
        </DialogContent>
      </Dialog>
    </>
  );
