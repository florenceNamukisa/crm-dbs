              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      <div
                        className={`w-full h-20 rounded ${themeOption.bg} border ${themeOption.border} mb-3`}
                      ></div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      key: "creditAlerts",
                      label: "Credit Alerts",
                      description: "Notify on credit sales activities",
                    },
                    {
                      key: "lowStockAlerts",
                      label: "Low Stock Alerts",
                      description: "Notify on low inventory",
                    },
                  ...
                  {[
                    {
                      value: "admin-only",
                      label: "Admin Only",
                      description: "Only send to admin",
                    },
                  ].map(({ value, label, description }) => (
                    <label
                      key={value}
                      className="flex items-center p-3 border border-gray-200 rounded-lg cursor-default bg-gray-50"
                    >
                      <input
                        type="radio"
                        ...
                        value={value}
                        checked={
                          notificationSettings.notificationRecipients === value
                        }
                        onChange={(e) =>
                          setNotificationSettings({
                            ...notificationSettings,
                ...
                <div className="space-y-4">
                  <label className="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-gray-600">
                        Require explicit consent for terms & privacy policy
                      </p>
                    </div>
                  </label>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-2">
                      How long to retain user data before deletion
                    </p>
                  </div>
                </div>
              </div>
